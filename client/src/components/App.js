...
class App extends React.Component{
    ...
    onSearchSubmit = async (term) => {
        ...
        var stop_id = "http://20.244.56.144:80/train/trains";
    ...
    fetchData = async() =>{
        ...
        var id_name = {}; 
        var temp_obj = {}
        const stop_name = await axios.get("http://20.244.56.144:80/train/trains", {}        
        ).then(function(value) {
    ...
    render(){
        ...
        return <div className="ui container" style={{ marginTop: '10px'}}> 
                ...
                <div>Found: {this.state.routes.length} routes</div>
                <br />
